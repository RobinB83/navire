 ...
 */
final class Version20201216142821 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE ais_ship_type_ais_ship_type ADD CONSTRAINT FK_56D6F52CE55133F9 FOREIGN KEY (ais_ship_type_source) REFERENCES aisshiptype (id) ON UPDATE NO ACTION ON DELETE CASCADE');
        $this->addSql('ALTER TABLE ais_ship_type_ais_ship_type ADD CONSTRAINT FK_56D6F52CFCB46376 FOREIGN KEY (ais_ship_type_target) REFERENCES aisshiptype (id) ON UPDATE NO ACTION ON DELETE CASCADE');
