 ...
 */
final class Version20201210094619 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE navire (id INT AUTO_INCREMENT NOT NULL, id_ais_ship_type_id INT NOT NULL, imo VARCHAR(7) NOT NULL, nom VARCHAR(100) NOT NULL, mmsi VARCHAR(9) NOT NULL, indicatif_appel VARCHAR(10) NOT NULL, eta DATETIME NOT NULL, INDEX IDX_EED1038A4145E55 (id_ais_ship_type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE navire ADD CONSTRAINT FK_EED1038A4145E55 FOREIGN KEY (id_ais_ship_type_id) REFERENCES ais_ship_type (id)');
    }
